export const PROPERTIES = [
  ...
  },
  {
    ...
    description:
      "For a while now we’ve been on the lookout for a parcel of land where we can try our hand at sub plating and then building a house from scratch. So imagine our excitement when we found this 17,000+ sq ft land that seems perfect for what we are trying to do. We’re in the early stages so the jury is still out…check back in a few months for a progress update!",
